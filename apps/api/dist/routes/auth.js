...
import { discordOAuth, getDiscordUser, getUserGuilds } from '../utils/discord';
...
router.post('/discord/callback', async (req, res) => {
    try {
        ...
        const user = await UserModel.findOneAndUpdate({ discordId: discordUser.id }, {
    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                guilds: user.guilds.map((guildId) => ({ id: guildId }))
            }
        });
    }
    catch (error) {
