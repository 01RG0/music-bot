...
async function handleViewSettings(interaction: ChatInputCommandInteraction, guildId: string) {
...
async function handleSetVolume(interaction: ChatInputCommandInteraction, guildId: string) {
  const volume = interaction.options.getInteger('level', true);

  await GuildSettingsModel.updateOne(
    { guildId },
    {
...
async function handleSetDJRole(interaction: ChatInputCommandInteraction, guildId: string) {
...
async function handleSetMaxQueue(interaction: ChatInputCommandInteraction, guildId: string) {
...
async function handleSetMaxDuration(interaction: ChatInputCommandInteraction, guildId: string) {
...
async function handleSetDuplicates(interaction: ChatInputCommandInteraction, guildId: string) {
...
async function handleSetAnnounce(interaction: ChatInputCommandInteraction, guildId: string) {
