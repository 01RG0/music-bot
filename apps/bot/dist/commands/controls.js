        ...
        async execute(interaction) {
            ...
            try {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields({ name: '👤 Author', value: currentTrack.info.author, inline: true }, { name: '⏱️ Duration', value: formatDuration(currentTrack.info.length), inline: true }, { name: '🎵 Source', value: currentTrack.info.sourceName, inline: true }, { name: '🔊 Volume', value: `${queueInfo.volume}%`, inline: true }, { name: '🔁 Loop', value: queueInfo.isLooping, inline: true }, { name: '⏯️ Status', value: queueInfo.isPaused ? 'Paused' : 'Playing', inline: true })
