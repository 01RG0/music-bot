...
export const filterCommands = [
    // Apply filter preset
    {
        data: new SlashCommandBuilder()
            ...
            .setRequired(true)
            .addChoices({ name: 'Bass Boost', value: 'bassboost' }, { name: 'Nightcore', value: 'nightcore' }, { name: 'Vaporwave', value: 'vaporwave' }, { name: '8D Audio', value: '8d' }, { name: 'Reset Filters', value: 'reset' })),
